...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combo2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "code", "grae", "value" }));
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
        ...
        try{
            ...
            String query = "Update t3 set "+combo1.getSelectedItem()+" = '"+t1.getText()+"' where "+combo2.getSelectedItem()+" = '"+t2.getText()+"';";
