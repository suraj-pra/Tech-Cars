 ...
 * @author admin
 */
public class Desc2 extends javax.swing.JFrame {

    /**
     * Creates new form Desc2
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(pr, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 420, 121, 31));
        ...
        getContentPane().add(scrollpane, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 340, 260));
        ...
        getContentPane().add(buy, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 490, 200, 50));

        fname.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        fname.setText("Login");
        getContentPane().add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 50, 160, 60));

        id.setFont(new java.awt.Font("Consolas", 0, 12)); // NOI18N
        id.setForeground(new java.awt.Color(51, 0, 51));
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 120, 210, 20));

        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon.jpg"))); // NOI18N
        getContentPane().add(icon, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 60, -1, -1));
    ...
    private void buyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyActionPerformed
        if(!id.getText().equals("")){
            PayMode p = new PayMode(null, this, 1);
            p.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Desc2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
