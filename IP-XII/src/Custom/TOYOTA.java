...
public class TOYOTA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 570, -1));
        ...
        jLabel8.setText("RUNNER");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 460, 190, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            stmt.executeUpdate("insert into design values(\"" + id + "\",\"toyota\"," + (price1 + price2) + ");");
            stmt.close();
            con.close();
        }
        catch(Exception e){
