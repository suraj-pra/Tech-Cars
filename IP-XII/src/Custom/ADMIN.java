...
public class ADMIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(pas, javax.swing.GroupLayout.PREFERRED_SIZE, 268, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 370, 190));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PICS/admiin.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 60, 260, 200));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 270, 250, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try{
            ...
            String query="select * from admin where adminid= '"+s+"' and password='"+pwd+"';";
            ...
            {
            JOptionPane.showMessageDialog(this,"AdminID or Password Not Match");
            }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        Both.Login l = new Both.Login(4, null, null, null);
        l.hmpg.setVisible(false);
        l.idlb.setText("AdminID:");
        l.code = "Admin";
        l.ch = 'a';
        l.setVisible(true);
        this.dispose();
