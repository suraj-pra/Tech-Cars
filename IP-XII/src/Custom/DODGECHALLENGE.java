 ...
 * @author CNS
 */
public class DODGECHALLENGE extends javax.swing.JFrame {

    /**
     * Creates new form DODGECHALLENGE
     */
    ...
    private void initComponents() {
        ...
        L2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PICS/redlcol.JPG"))); // NOI18N
        ...
        getContentPane().add(P1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 150, 240));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 460, 100, -1));
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, 470, 270));

        jLabel8.setFont(new java.awt.Font("Viner Hand ITC", 3, 36)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("CHALLENGER");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 460, 290, 40));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 670, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            stmt.executeUpdate("insert into design values(\"" + id + "\",\"dodgechallenge\"," + (price1 + price2) + ");");
            stmt.close();
            con.close();
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DODGECHALLENGE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DODGECHALLENGE().setVisible(true);
            }
        });
    }
